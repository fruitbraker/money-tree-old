...
INSERT INTO expense(transaction_date, transaction_amount, vendor_id, expense_category, metadata, hide) VALUES (now(), 9.99, 1, 'EXPENSE_CATEGORY_1', 1, false);
INSERT INTO expense(transaction_date, transaction_amount, vendor_id, expense_category, metadata, hide) VALUES (now(), 10.43, 2, 'EXPENSE_CATEGORY_2', 2, true);
